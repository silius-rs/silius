...
mod tests {
    ...
    async fn user_operation_simulation() {
        ...
        let entry_point = "0x2DF1592238420ecFe7f2431360e224707e77fA0E"
            .parse::<Address>()
            .unwrap();
        let eth_provider =
        ...
        let user_operation_valid = UserOperation {
            sender: "0x69F8c0f31B00926933029547CeD1Ca9D1b3b08ec".parse().unwrap(),
            nonce: U256::zero(),
            init_code: Bytes::from_str("0xe19e9755942bb0bd0cccce25b1742596b8a8250b3bf2c3e70000000000000000000000002df1592238420ecfe7f2431360e224707e77fa0e000000000000000000000000ae72a48c1a36bd18af168541c53037965d26e4a800000000000000000000000000000000000000000000000000000185d68e83b5").unwrap(),
            call_data: Bytes::from_str("").unwrap(),
            call_gas_limit: U256::from(22004),
            verification_gas_limit: U256::from(1218415),
            pre_verification_gas: U256::from(48940),
            max_fee_per_gas: U256::from(2496610946 as u64),
            max_priority_fee_per_gas: U256::from(1500000000 as u64),
            paymaster_and_data: Bytes::default(),
            signature: Bytes::from_str("0x30782618d4b8ba3ee5a09fde6cd7fa146f19ab2fbac7cf0dd19f0e55212cb845487842296d8208aab5034cb6b6b2e8b84d03175e49f800fbfdc1e8d7dd919add1b").unwrap(),
        };
